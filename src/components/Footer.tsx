  ...
  return (
    <footer className="bg-white border-t border-slate-100 pt-24 pb-12">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-16 mb-24 max-w-7xl mx-auto">
          <div className="col-span-2 space-y-8">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest bg-slate-50 border border-slate-100 rounded-full text-slate-400">SIL 3 / PLd Certified</span>
              <span className="px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest bg-slate-50 border border-slate-100 rounded-full text-slate-400">Black-Channel Protocol</span>
        ...
        <div className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em] max-w-7xl mx-auto">
